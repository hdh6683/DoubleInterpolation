...
#define SEARCH_ALGORITHM 4		  // 0 ~ 4	0:original	1:for문 최적화	2:for문+루프변수	3:이진탐색	4:정수 최적화
#define INTERPOLATION_ALGORITHM 3 // 0 ~ 2	2:쓸데 없는 조건 지움		3:정수화 테이블 이용
#define INTEGER_OPTIMIZE 1		  // 정수 최적화 0,1
...
#endif
#if(INTEGER_OPTIMIZE)
	Id.Out = DoubleInterpolataion(&Id, IntIdTable);
#else
